...
const Footer = () => {
  return (
    <footer>
      ...
      <div className="bg-gradient-to-r from-dark-teal to-light-teal fixed bottom-0 left-0 right-0">
        <div className="flex flex-row justify-between">
          ...
          <div className="text-white flex flex-row  pt-5">
            ...
            <a
              href={"https://github.com/MichaelARestrepoross/nyc-squirrel-census-visualization-project/pull/8/"}
              target="_blank"
            >
