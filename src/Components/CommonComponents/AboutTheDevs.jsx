...
const AboutTheDevs = () => {
  return (
    <div>
      <div className="h-screen md-min-h-[300-vh] md-mb-72 md-h-auto bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('https://res.cloudinary.com/dwygxzqku/image/upload/v1714886654/SquirrelQuest/acorn-background.jpg')" }}>
